    ...
    return (
        <div className='post-card'>
                ...
                <div className='flex items-center gap-3'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='flex-center gap-2 text-light-3'>
                            <p title={formatDateString(post.$createdAt)} className='subtle-semibold lg:small-regular'> {formatRelativeTime(post.$createdAt)} </p> -
            ...
            <Link to={`/posts/${post.$id}`}>
                ...
                <img src={post.imageUrl || '/assets.icons.profile-placeholder.svg'} className='post-card_img' alt='Image' />
            </Link>
