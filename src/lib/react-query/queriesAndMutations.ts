...
export const useUpdatePost = () => {
    ...
    return useMutation({
        mutationFn: (post: IUpdatePost) => updatePost(post), onSuccess: (data) => {
            queryClient.invalidateQueries({
                queryKey: [QUERY_KEYS.GET_POST_BY_ID, data?.$id]
            })
        }
...
export const useDeletePost = () => {
    ...
    return useMutation({
        mutationFn: ({postId, imageId} : {postId: string, imageId: string}) => deletePost(postId, imageId), onSuccess: (_data) => {
            queryClient.invalidateQueries({
                queryKey: [QUERY_KEYS.GET_RECENT_POSTS]
            })
        }
